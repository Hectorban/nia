defmodule NiaWeb.StackedLayout do
  @moduledoc """
  A responsive layout with a top navbar, as well as a drop down menu up the top right (user menu).

  The menu items use the same structure as what is used in `NiaWeb.SidebarMenu.nav_menu/1` - please read the docs for that function to get a sense of the data structure for menu items.
